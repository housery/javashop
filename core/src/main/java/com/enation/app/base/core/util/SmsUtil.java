...
public class SmsUtil {
	...
	// 商标前缀
	private static final String BRAND_PREFIX = "升下印材";
	...
	public static Map<String, Object> sendMobileSms(String mobile, String key, int isCheckRegister) {
		...
		try {
			...
			if (key.equals(SmsTypeKeyEnum.LOGIN.toString())) {
				smsContent = "您的登录验证码为：" +  dynamicCode + ", 上海邻巨网络技术有限公司 【" + BRAND_PREFIX + "】";
			...
			// 2如果是注册
				...
				smsContent = "您的注册验证码为：" +  dynamicCode + ", 上海邻巨网络技术有限公司 【" + BRAND_PREFIX + "】";
			...
			// 3如果是找回密码
				...
				smsContent = "您正在尝试找回密码，验证码为：" +  dynamicCode + ", 上海邻巨网络技术有限公司 【" + BRAND_PREFIX + "】";
			...
			// 4是绑定帐号
				...
				smsContent = "您正在绑定手机号，验证码为：" +  dynamicCode + ", 上海邻巨网络技术有限公司 【" + BRAND_PREFIX + "】";
			...
			// 5是修改密码
				...
				smsContent = "您正在修改密码，验证码为：" +  dynamicCode + ", 上海邻巨网络技术有限公司 【" + BRAND_PREFIX + "】";
			...
			// 6是普通校验
				...
				smsContent = "您好，您的验证码为：" +  dynamicCode + ", 上海邻巨网络技术有限公司 【" + BRAND_PREFIX + "】";
			}
