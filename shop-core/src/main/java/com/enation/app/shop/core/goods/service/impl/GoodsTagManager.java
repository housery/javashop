...
import com.enation.app.shop.core.goods.model.mapper.AdvMapper;
import com.enation.app.shop.core.goods.model.mapper.GoodsMapper;
...
public class GoodsTagManager  implements IGoodsTagManager {
	...
	public List<Goods> listgoodstag() {
		...
		sql.append(" and r.tag_id = 1");
		sql.append(" order by r.ordernum desc");
		List<Goods> list = this.daoSupport.queryForList(sql.toString(),new GoodsMapper());
		return list;
	}
